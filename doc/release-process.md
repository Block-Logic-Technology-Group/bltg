...
### Build and sign BLTG Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit bltg=v${VERSION} ../bltg/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit bltg=v${VERSION} ../bltg/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit bltg=v${VERSION} ../bltg/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit bltg=v${VERSION} ../bltg/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../bltg/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/bltg-*.tar.gz build/out/src/bltg-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`bltg-${VERSION}-osx-unsigned.dmg`, `bltg-${VERSION}-osx64.tar.gz`)
...
Codesigner only: Sign the osx binary:
    ...
    transfer bltg-osx-unsigned.tar.gz to osx for signing
...
space *do not upload these to the bltg.org server*.
