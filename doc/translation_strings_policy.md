...
This document provides guidelines for internationalization of the BLTG Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to BLTG network</numerusform>
            <numerusform>%n active connections to BLTG network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bltg_en.ts` remains unchanged.
