UNIX BUILD NOTES
====================
Some notes on how to build BLTG in Unix.

Note
---------------------
Always use absolute paths to configure and compile bltg and the dependencies,
...
memory available when compiling BLTG Core. With 512MB of memory or less
...
# Pick some path to install BDB to, here we create a directory within the bltg directory
BDB_PREFIX="${BLTG_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure BLTG Core to use our own-built instance of BDB
cd $BLTG_ROOT
...
* _Non-executable Stack_: If the stack is executable then trivial stack based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, bltg should be built with a non-executable stack
