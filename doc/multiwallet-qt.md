...
In order to support loading of multiple wallets in bltg-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bltg.cpp.
...
Changes to bltg.cpp
----------------------
bltg.cpp is the entry point into bltg-qt, and as such, will require some minor modifications to provide hooks for
