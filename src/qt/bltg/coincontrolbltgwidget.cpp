...
#include "qt/bltg/coincontrolbltgwidget.h"
#include "qt/bltg/forms/ui_coincontrolbltgwidget.h"

CoinControlBltgWidget::CoinControlBltgWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlBltgWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select BLTG Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BLTG");
    ...
    ui->labelValueAfter->setText("0.00 BLTG");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BLTG");
    ui->labelValueFee->setText("0.00 BLTG");
...
CoinControlBltgWidget::~CoinControlBltgWidget()
{
    delete ui;
}
