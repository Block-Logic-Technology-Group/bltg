...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    string debugCategories = "addrman, alert, bench, coindb, db, lock, rand, rpc, selectcoins, tor, mempool, net, proxy, http, libevent, bltg, (obfuscation, swiftx, masternode, mnpayments, mnbudget, zero)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        debugCategories += ", qt";
...
//    strUsage += "  -anonymizebltgamount=<n>     " + strprintf(_("Keep N BLTG anonymized (default: %u)"), 0) + "\n";
...
//    }
//
//    nAnonymizeBltgAmount = GetArg("-anonymizebltgamount", 0);
//    if (nAnonymizeBltgAmount > 999999) nAnonymizeBltgAmount = 999999;
//    if (nAnonymizeBltgAmount < 2) nAnonymizeBltgAmount = 2;
    ...
    LogPrintf("Anonymize BLTG Amount %d\n", nAnonymizeBltgAmount);
