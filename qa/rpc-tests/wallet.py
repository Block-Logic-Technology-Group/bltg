...
#   c) node1 mines 32 blocks, so now node 0 has 60001bltg, node 1 has 4250bltg, node2 has none.
#   d) node0 sends 601 bltg to node2, in two transactions (301 bltg, then 300 bltg).
