Contributing to BLTG Core
============================

The BLTG Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Block-Logic-Technology-Group/bltg/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BLTG Core project, and is not to be
confused with overall BLTG Network Protocol consensus changes.

Whether a pull request is merged into BLTG Core rests with the project merge
...
Patches that change BLTG consensus rules are considerably more involved than
...
Where a patchset proposes to change the BLTG consensus, it must have been
...
The project leader is the release manager for each BLTG Core release.
