...
RESOURCES += src/qt/bltg.qrc src/qt/bltg_locale.qrc

TRANSLATIONS += src/qt/locale/bltg_bg.ts \
                src/qt/locale/bltg_de.ts \
                src/qt/locale/bltg_en.ts \
                src/qt/locale/bltg_es.ts \
                src/qt/locale/bltg_fi.ts \
                src/qt/locale/bltg_fr.ts \
                src/qt/locale/bltg_it.ts \
                src/qt/locale/bltg_ja.ts \
                src/qt/locale/bltg_pl.ts \
                src/qt/locale/bltg_pt.ts \
                src/qt/locale/bltg_ru.ts \
                src/qt/locale/bltg_sk.ts \
                src/qt/locale/bltg_sv.ts \
                src/qt/locale/bltg_vi.ts \
                src/qt/locale/bltg_zh_CN.ts \
                src/qt/locale/bltg_zh_TW.ts
